        ...
        **Exceptions: None.
        ...
        internal static bool IsTrueStringIgnoreCase(ReadOnlySpan<char> value)
        {
            return value.Length == 4 &&
                   (ASCIIUtility.ReadFirst4CharsAsUInt64(value) | 0x0020002000200020) == ASCIIUtility.SmallStringTo64BitInt("true");
        }

        internal static bool IsFalseStringIgnoreCase(ReadOnlySpan<char> value)
        {
            return value.Length == 5 &&
                   (ASCIIUtility.ReadFirst4CharsAsUInt64(value) | 0x0020002000200020) == ASCIIUtility.SmallStringTo64BitInt("fals") &&
                   ((value[4] | 0x20) == 'e');
        }
