...
namespace System.Runtime.Intrinsics
{
    ...
    public static unsafe class Vector256
    {
        ...
        /// <summary>Creates a new <see cref="Vector256{T}" /> instance with all 64-bit elements initialized to the specified <see cref="Vector64{T}" /> value.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="value">The <see cref="Vector64{T}" /> value that all 64-bit elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector256{T}" /> with all 64-bit elements initialized to <paramref name="value" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="value" /> (<typeparamref name="T" />) is not supported.</exception>
        ...
        public static Vector256<T> Create<T>(Vector64<T> value)
        {
            ...
            return Vector256.Create(vec128, vec128);
        }

        /// <summary>Creates a new <see cref="Vector256{T}" /> instance with all 128-bit elements initialized to the specified <see cref="Vector128{T}" /> value.</summary>
        /// <typeparam name="T">The type of the elements in the vector.</typeparam>
        /// <param name="value">The <see cref="Vector128{T}" /> value that all 128-bit elements will be initialized to.</param>
        /// <returns>A new <see cref="Vector256{T}" /> with all 128-bit elements initialized to <paramref name="value" />.</returns>
        /// <exception cref="NotSupportedException">The type of <paramref name="value" /> (<typeparamref name="T" />) is not supported.</exception>
        [Intrinsic]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
