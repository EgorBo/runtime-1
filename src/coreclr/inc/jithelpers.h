...
// It will be set in InitJITHelpers2
    ...
    // FOH allocators
    JITHELPER(CORINFO_HELP_NEWSFAST_FROZEN,             JIT_NewFrozen,    CORINFO_HELP_SIG_REG_ONLY)
    JITHELPER(CORINFO_HELP_NEWARR_1_DIRECT_FROZEN,      JIT_NewArr1Frozen,CORINFO_HELP_SIG_REG_ONLY)
