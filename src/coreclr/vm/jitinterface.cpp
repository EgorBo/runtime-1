...
CORINFO_CLASS_HANDLE CEEInfo::getTypeHandleFromRuntimeTypePointer(CORINFO_OBJECT_HANDLE obj)
{
    CONTRACTL{
        THROWS;
        GC_TRIGGERS;
    ...
    _ASSERT(type == g_pRuntimeTypeClass);
    result = (CORINFO_CLASS_HANDLE)((REFLECTCLASSBASEREF)objRef)->GetType().AsMethodTable();
