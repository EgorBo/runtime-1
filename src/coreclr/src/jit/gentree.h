...
{
    unsigned gtThenBbFlags;
    unsigned gtElseBbFlags;
    ...
    GenTreeColon(var_types typ, GenTree* thenNode, GenTree* elseNode) : GenTreeOp(GT_COLON, typ, elseNode, thenNode), gtThenBbFlags(0), gtElseBbFlags(0)
    {
    }
};
