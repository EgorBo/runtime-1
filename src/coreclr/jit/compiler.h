...
public:
    ...
    bool optAssertionVNIsSubtype(ValueNum objVN, ValueNum castToVN, ASSERT_VALARG_TP assertions, int* pBudget);
    bool optAssertionVNIsNonNull(ValueNum vn, ASSERT_VALARG_TP assertions);
    bool optAssertionVNIsNonNull(ValueNum vn, ASSERT_VALARG_TP assertions, int* pBudget);
