...
#define OMF_HAS_GDV_CANDIDATES                 0x00020000 // Method contains candidates for GDV
    ...
    bool doesMethodHaveGDVCandidates() const
    {
        return (optMethodFlags & OMF_HAS_GDV_CANDIDATES) != 0;
    }

    void setMethodHasGDVCandidates()
    {
        optMethodFlags |= OMF_HAS_GDV_CANDIDATES;
    }
