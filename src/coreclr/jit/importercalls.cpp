    ...
    *pIntrinsicName = ni;
    ...
    if (ni != NI_Illegal)
    {
        ...
        switch (ni)
        {
            ...
            case NI_System_Text_UTF8Encoding_UTF8EncodingSealed_TryGetAsciiConstData:
...
#error Unsupported platform
            ...
            else if (strcmp(namespaceName, "Text") == 0)
            {
                ...
                {
                    if (strcmp(methodName, "TryGetAsciiConstData") == 0)
                    {
                        assert(strcmp(enclosingClassName, "UTF8Encoding") == 0);
                        result = NI_System_Text_UTF8Encoding_UTF8EncodingSealed_TryGetAsciiConstData;
                    }
                }
            }
