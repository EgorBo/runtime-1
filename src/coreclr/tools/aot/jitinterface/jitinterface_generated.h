...
struct JitInterfaceCallbacks
{
    ...
    bool (* isPinvoke)(void * thisHandle, CorInfoExceptionClass** ppException, CORINFO_METHOD_HANDLE ftn);
          ...
          CORINFO_METHOD_HANDLE ftn)
{
    ...
    virtual bool isPinvoke(
          CORINFO_METHOD_HANDLE ftn)
{
    CorInfoExceptionClass* pException = nullptr;
    bool temp = _callbacks->isPinvoke(_thisHandle, &pException, ftn);
    if (pException != nullptr) throw pException;
    return temp;
}
