...
public:
    ...
    void recGetReadonlyStaticFieldValue(CORINFO_FIELD_HANDLE field, uint8_t* buffer, int bufferSize, CorInfoObjectValueKind kind, bool result);
    void dmpGetReadonlyStaticFieldValue(Agnostic_GetReadonlyStaticFieldValueKey key, DD value);
    bool repGetReadonlyStaticFieldValue(CORINFO_FIELD_HANDLE field, uint8_t* buffer, int bufferSize, CorInfoObjectValueKind kind);
