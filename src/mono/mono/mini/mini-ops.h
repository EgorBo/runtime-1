...
MINI_OP(OP_SSE_COMIEQSS, "sse_comieq_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_COMIGTSS, "sse_comigt_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_COMIGESS, "sse_comige_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_COMILTSS, "sse_comilt_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_COMILESS, "sse_comile_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_COMINEQSS, "sse_comineq_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMIEQSS, "sse_ucomieq_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMIGTSS, "sse_ucomigt_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMIGESS, "sse_ucomige_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMILTSS, "sse_ucomilt_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMILESS, "sse_ucomile_ss", IREG, XREG, XREG)
MINI_OP(OP_SSE_UCOMINEQS, "sse_ucomineq_s", IREG, XREG, XREG)
