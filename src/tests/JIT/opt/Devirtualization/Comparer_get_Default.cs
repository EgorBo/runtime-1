...
class Program
{
    ...
    private static void GetTypeTests()
    {
        ...
        AssertEquals("System.Collections.Generic.NullableEnumComparer`1[System.Runtime.CompilerServices.MethodImplOptions]", Comparer<MethodImplOptions?>.Default.GetType().ToString());
